...
cat <<vEOF >$BUILD_DIR/anyproxy/version.go
package anyproxy
...
vEOF
    echo "Wrote $BUILD_DIR/anyproxy/version.go: timestamp=$timestamp; builduser=$builduser; buildhost=$buildhost"
}
...
{
    make_version
    go build anyproxy/any_proxy.go anyproxy/sni.go anyproxy/stats.go anyproxy/ProxyConnection.go anyproxy/version.go
